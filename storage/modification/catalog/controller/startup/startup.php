...
class ControllerStartupStartup extends Controller {
	public function index() {
		...
		if (!isset($this->request->cookie['language']) || $this->request->cookie['language'] != $code) {
			...
			setcookie('language', $code, ['expires' => time() + 60 * 60 * 24 * 30, 'path' => '/', 'domain' => $this->request->server['HTTP_HOST'], 'samesite' => 'None', 'secure' => true, 'httponly' => true]);
		}
		...
		if (!isset($this->request->cookie['currency']) || $this->request->cookie['currency'] != $code) {
			...
			setcookie('currency', $code, ['expires' => time() + 60 * 60 * 24 * 30, 'path' => '/', 'domain' => $this->request->server['HTTP_HOST'], 'samesite' => 'None', 'secure' => true, 'httponly' => true]);
		}		
