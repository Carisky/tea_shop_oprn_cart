...
class ControllerExtensionShippingInpost extends Controller {
    ...
    public function index()
    {
		...
		if (isset($this->request->post['shipping_inpost_total_courier'])) {
			$data['shipping_inpost_total_courier'] = $this->request->post['shipping_inpost_total_courier'];
		} else {
			$data['shipping_inpost_total_courier'] = $this->config->get('shipping_inpost_total_courier');
		}
