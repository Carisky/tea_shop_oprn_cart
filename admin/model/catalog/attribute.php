...
class ModelCatalogAttribute extends Model {
	public function addAttribute($data) {
		...
		foreach ($data['attribute_description'] as $language_id => $value) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_description SET attribute_id = '" . (int)$attribute_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', values_list = '" . $this->db->escape($value['values_list']) . "'"); //Noir
		}
		
		if(isset($data['hidden'])) { //Noir
			$this->db->query("UPDATE ".DB_PREFIX."attribute SET hidden = ".(int)$data['hidden']." WHERE attribute_id = ".$attribute_id);
		}
	...
	public function getAttributeDescriptions($attribute_id) {
		...
		foreach ($query->rows as $result) {
			...
			$attribute_data[$result['language_id']] = $result; //Noir
		}
