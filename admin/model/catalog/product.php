	...
	public function addProduct($data) {
		...
		if (isset($data['product_image'])) {
			foreach ($data['product_image'] as $product_image) {
				...
				$product_image_id = $this->db->getLastId(); //Noir
				if(isset($product_image['in_desc'])) $this->db->query("UPDATE ".DB_PREFIX."product_image SET in_desc = ".(int)$product_image['in_desc']." WHERE product_image_id = ".$product_image_id); //Noir
			}
		}
