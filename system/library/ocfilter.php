...
final class OCFilter {
  ...
  public function getSelectedOptions() {
    ...
    if ($this->min_price_get && $this->max_price_get) { //
		$left = $this->currency->getSymbolLeft($this->session->data['currency']) ? '<i>'.$this->currency->getSymbolLeft($this->session->data['currency']).'</i>' : '';
		$right = $this->currency->getSymbolRight($this->session->data['currency']) ? '<i>'.$this->currency->getSymbolRight($this->session->data['currency']).'</i>' : '';
		...
		$category_options[] = array(
			...
			'values'    => array(array(
				...
				'name' => $left . $this->min_price_get . ' - ' . $this->max_price_get . $right
			))
		);
    }
