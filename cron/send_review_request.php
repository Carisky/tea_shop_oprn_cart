...
$mail = new Mail(isset($settings['config_mail_engine']) ? $settings['config_mail_engine'] : 'mail');
$mail->parameter = isset($settings['config_mail_parameter']) ? $settings['config_mail_parameter'] : '';
...
$from_email = isset($settings['config_email']) ? $settings['config_email'] : '';
$store_name = isset($settings['config_name']) ? $settings['config_name'] : '';
